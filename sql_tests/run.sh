...
for f in sql_tests/harness.sql supabase_casino.sql supabase_casino_v2.sql supabase_duel.sql supabase_duel_v2.sql supabase_exam_history.sql supabase_leaderboard.sql sql_tests/suite.sql sql_tests/exam_history_suite.sql sql_tests/duel_v2_suite.sql sql_tests/leaderboard_suite.sql; do
  docker cp "$f" $NAME:/tmp/ >/dev/null
done

for f in harness.sql supabase_casino.sql supabase_casino_v2.sql supabase_duel.sql supabase_duel_v2.sql supabase_exam_history.sql supabase_leaderboard.sql; do
  echo "--- installing $f"
